					...
					<div class="container-fluid">
						<div class="d-flex">
							<a class="header-brand" href="index-1.html">
								<img src="assets\images\brand\logo.png" class="header-brand-img" alt="Smiley face">
							</a>
							...
							<div class="d-flex order-lg-2 ml-auto header-right-icons header-search-icon">
								...
								<div class="dropdown text-center selector">
									<a href="#" class="nav-link leading-none" data-toggle="dropdown">
										<span class="avatar avatar-sm brround cover-image" data-image-src="assets/images/faces/female/25.jpg" alt="Smiley face">Logout</span> 
									</a>
